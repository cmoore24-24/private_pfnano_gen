...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/cascade/2.2.04-5dba63b65781eea7116754534f070379/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/cgal/4.2-pafccj2/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/charybdis/1.003-4547ab401f4b95bddc2a081b9c2256e4/include
...
cuda-api-wrappers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/cuda-api-wrappers/20180504-pafccj5/include
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/davix/0.6.7-pafccj2/include/davix
davix_EX_LIB := davix
...
dd4hep-core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/dd4hep/v01-10x-pafccj9/include
...
ALL_TOOLS      += dire
dire_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/dire/2.003-793ebb67e0a3f0649d6af63dfd57e977/include
dire_EX_LIB := dire
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/eigen/e4c107b451c52c9ab2d7b7fa4194ee35332916ec-pafccj2/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/evtgen/1.6.0-b93dfbaeb983959129928e302564c903/include
...
ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/gbl/V02-01-03-pafccj2/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen

ALL_TOOLS      += gcc-analyzer-ccompiler
gcc-analyzer-ccompiler_EX_FLAGS_CFLAGS  := -fplugin=/cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/gcc-checker-plugin/1.2-pafccj2/lib/libchecker_gccplugins.so -fplugin-arg-libchecker_gccplugins-checkers=all -fsyntax-only

ALL_TOOLS      += gcc-analyzer-cxxcompiler
gcc-analyzer-cxxcompiler_EX_FLAGS_CXXFLAGS  := -fplugin=/cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/gcc-checker-plugin/1.2-pafccj2/lib/libchecker_gccplugins.so -fplugin-arg-libchecker_gccplugins-checkers=all -fsyntax-only
...
gcc-checker-plugin_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/gcc-checker-plugin/1.2-pafccj2/include
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/geant4/10.4.3-pafccj2/include/Geant4
...
ALL_TOOLS      += geneva
geneva_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/geneva/1.0-RC3-9a3400920bb996a6247561e0d2fa60c3/include/Geneva
...
google-benchmark_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/google-benchmark/1.4.x-pafccj2/include
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/hector/1.3.4_patch1-pafccj9/include
...
ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/herwig/6.521-aaee051df934a7173d861b9a4fe4b52a/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwig7
herwig7_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/herwig7/7.2.2-7b024d0478fdc14732406b507235be5c/include
herwig7_EX_LIB := HerwigAPI
herwig7_EX_USE := root_cxxdefaults lhapdf thepeg madgraph5amcatnlo openloops

ALL_TOOLS      += highfive
highfive_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/highfive/2.0-pafccj/include
...
ALL_TOOLS      += ittnotify
ittnotify_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/ittnotify/16.06.18-pafccj2/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/jimmy/4.2-5d561308b8221b26a0fd1eab7de940b0/include
...
ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/ktjet/1.06-pafccj2/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/lhapdf/6.2.3-f9f0c7ff52c430bdce541de202b20196/include
...
libjpeg-turbo_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/libjpeg-turbo/2.0.1-pafccj2/include
...
ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/libtiff/4.0.3-pafccj2/include
libtiff_EX_LIB := tiff
...
ALL_TOOLS      += libunwind
libunwind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/libunwind/1.2.1-pafccj/include
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/llvm/7.1.0-pafccj/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/lwtnn/2.4-pafccj2/include
lwtnn_EX_LIB := lwtnn
lwtnn_EX_USE := root_cxxdefaults eigen boost_system

ALL_TOOLS      += lz4
lz4_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/lz4/1.9.2-pafccj/include
lz4_EX_LIB := lz4
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/mctester/1.25.0a-pafccj9/include
...
mxnet-predict_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/mxnet-predict/1.5.0-pafccj2/include
...
onnxruntime_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/onnxruntime/1.3.0-pafccj/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/pythia8/240-6624867d4b41bc2d6038d7aa36b21afb/include
...
ALL_TOOLS      += qt
qt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/QtOpenGL /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/Qt3Support
qt3support_EX_LIB := Qt3Support
qt3support_EX_USE := root_cxxdefaults qtbase
qt3support_EX_FLAGS_CPPDEFINES  := -DQT3_SUPPORT

ALL_TOOLS      += qtbase
qtbase_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/Qt /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/QtCore /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/QtXml
...
qtdesigner_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/qt/4.8.7-pafccj2/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/rivet/2.7.0-pafccj8/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/lcg/root/6.14.09-pafccj5/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/lcg/root/6.14.09-pafccj5/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/lcg/root/6.14.09-pafccj5/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL17wmLHE/env/CMSSW_10_6_29/src /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL17wmLHE/env/CMSSW_10_6_29/include/slc7_amd64_gcc820/src /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL17wmLHE/env/CMSSW_10_6_29/include/LCG /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/cmssw/CMSSW_10_6_29/src /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/cmssw/CMSSW_10_6_29/include/slc7_amd64_gcc820/src /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/cmssw/CMSSW_10_6_29/include/LCG
self_EX_LIBDIR := /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL17wmLHE/env/CMSSW_10_6_29/lib/slc7_amd64_gcc820 /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL17wmLHE/env/CMSSW_10_6_29/external/slc7_amd64_gcc820/lib /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/cmssw/CMSSW_10_6_29/lib/slc7_amd64_gcc820 /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/cmssw/CMSSW_10_6_29/external/slc7_amd64_gcc820/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/sherpa/2.2.11-0e4f12ac50efca1705b094d3d2f59074/include/SHERPA-MC
...
ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/starlight/r193-pafccj2/include
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/tauolapp/1.1.5-4d7c2230a4ff6fa75893c4348b80796a/include
...
tensorflow_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/tensorflow/1.6.0-pafccj5/include

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/thepeg/2.2.2-cd3f9cde25ba01b9041a2acab5531208/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml2
tinyxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/tinyxml2/6.2.0-pafccj2/include
tinyxml2_EX_LIB := tinyxml2

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/tkonlinesw/4.2.0-1_gcc7-pafccj9/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/vdt/0.4.0-pafccj2/include
...
vecgeom_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/vecgeom/v00.05.00-pafccj2/include
...
ALL_TOOLS      += vincia
vincia_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/vincia/2.2.04-3d551a7bde40db70ea7258d083c418cc/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/xrootd/4.8.5-pafccj2/include/xrootd /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/xrootd/4.8.5-pafccj2/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xtensor
xtensor_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/xtensor/0.20.1-pafccj/include
xtensor_EX_USE := xtl

ALL_TOOLS      += xtl
xtl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/xtl/0.6.3-pafccj/include
...
ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/yaml-cpp/0.6.2-pafccj2/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/yoda/1.7.4-pafccj9/include
yoda_EX_LIB := YODA

...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/blackhat/0.9.9-ikhhed/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/boost/1.57.0-ikhhed/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/boost/1.57.0-ikhhed/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/boost/1.57.0-ikhhed/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/cascade/2.2.04-ikhhed3/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/cgal/4.2-ikhhed/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/charybdis/1.003-ikhhed3/include
...
ALL_TOOLS      += clhep
clhep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/clhep/2.2.0.4-ikhhed2/include
clhep_EX_LIB := CLHEP
clhep_EX_USE := root_cxxdefaults
clhep_EX_FLAGS_CXXFLAGS  := -Wno-error=unused-variable

ALL_TOOLS      += clhepheader
clhepheader_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/clhep/2.2.0.4-ikhhed2/include
...
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/cms/coral/CORAL_2_3_21-ikhhed6/include/LCG
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/davix/0.6.4-ikhhed/include/davix
davix_EX_LIB := davix
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/eigen/3.2.2-ikhhed/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/evtgen/1.5.0-ikhhed4/include
...
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/frontier_client/2.8.20-ikhhed/include
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/geant4/10.00.p03-ikhhed2/include/Geant4
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/hector/1.3.4_patch1-ikhhed7/include
...
ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/heppdt/3.03.00-giojec/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/herwig/6.521-ikhhed3/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/herwigpp/2.7.1-ikhhed3/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/jemalloc/4.2.1/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/jimmy/4.2-ikhhed3/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/ktjet/1.06-ikhhed2/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/lhapdf/6.1.6-ikhhed2/include
...
ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/libxslt/1.1.28-ikhhed/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/llvm/3.8.0-ikhhed/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/lwtnn/1.0-ikhhed/include
lwtnn_EX_LIB := lwtnn
lwtnn_EX_USE := eigen
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/mctester/1.25.0a-ikhhed7/include
mctester_EX_LIB := HEPEvent HepMCEvent MCTester
mctester_EX_USE := root_cxxdefaults root hepmc

ALL_TOOLS      += md5
md5_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/md5/1.0.0/include
md5_EX_LIB := cms-md5
...
ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/oracle/11.2.0.3.0__10.2.0.4.0-ikhhed/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/pythia8/212-ikhhed4/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/python/2.7.11-ikhhed/include/python2.7
...
ALL_TOOLS      += qt
qt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/QtOpenGL /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/Qt3Support
qt3support_EX_LIB := Qt3Support
qt3support_EX_USE := root_cxxdefaults qtbase
qt3support_EX_FLAGS_CPPDEFINES  := -DQT3_SUPPORT

ALL_TOOLS      += qtbase
qtbase_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/Qt /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/QtCore /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/QtXml
...
qtdesigner_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/qt/4.8.7/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/rivet/2.4.0-ikhhed2/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/lcg/root/6.06.00-ikhhed7/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/lcg/root/6.06.00-ikhhed7/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/lcg/root/6.06.00-ikhhed7/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL16APVwmLHE/env/CMSSW_8_0_33_UL/src /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL16APVwmLHE/env/CMSSW_8_0_33_UL/include/LCG /cvmfs/cms.cern.ch/slc7_amd64_gcc530/cms/cmssw/CMSSW_8_0_33_UL/src /cvmfs/cms.cern.ch/slc7_amd64_gcc530/cms/cmssw/CMSSW_8_0_33_UL/include/LCG
self_EX_LIBDIR := /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL16APVwmLHE/env/CMSSW_8_0_33_UL/lib/slc7_amd64_gcc530 /uscms_data/d3/cjmoore/powheg/test/MYOMC/RunIISummer20UL16APVwmLHE/env/CMSSW_8_0_33_UL/external/slc7_amd64_gcc530/lib /cvmfs/cms.cern.ch/slc7_amd64_gcc530/cms/cmssw/CMSSW_8_0_33_UL/lib/slc7_amd64_gcc530 /cvmfs/cms.cern.ch/slc7_amd64_gcc530/cms/cmssw/CMSSW_8_0_33_UL/external/slc7_amd64_gcc530/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/sherpa/2.2.0-ikhhed7/include/SHERPA-MC
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/sqlite/3.12.2-giojec2/include
sqlite_EX_LIB := sqlite3
sqlite_EX_USE := root_cxxdefaults

ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/starlight/r193-ikhhed2/include
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/tauolapp/1.1.5-ikhhed4/include
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/thepeg/1.9.2p1-ikhhed3/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/tinyxml/2.5.3-ikhhed/include
tinyxml_EX_LIB := tinyxml

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/tkonlinesw/4.0.0-1-ikhhed6/include
...
ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/utm/r47119-xsd310-patch-ikhhed/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/cms/vdt/v0.3.2-giojec2/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/xrootd/4.5.0-ikhhed2/include/xrootd /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/xrootd/4.5.0-ikhhed2/include/xrootd/private
...
ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/yaml-cpp/0.5.1-ikhhed/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/yoda/1.5.5-ikhhed2/include
yoda_EX_LIB := YODA
yoda_EX_USE := boost

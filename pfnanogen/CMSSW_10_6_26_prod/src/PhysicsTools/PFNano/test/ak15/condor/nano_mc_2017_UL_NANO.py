...
#JetToolbox Addition Attempt
#from JMEAnalysis.JetToolbox.nanoAOD_jetToolbox_cff import setupCustomizedJetToolbox

#call of jet toolbox customization function
#process = setupCustomizedJetToolbox(process)
